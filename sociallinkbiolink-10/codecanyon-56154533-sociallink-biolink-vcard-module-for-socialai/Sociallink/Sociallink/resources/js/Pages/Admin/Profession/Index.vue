...
import Paginate from '@root/Components/Admin/Paginate.vue'
...
const storeCategory = () => {
  categoryForm.post(route('admin.sociallink.profession.store'), {
    onSuccess: () => {
      categoryForm.reset()
...
const updateCategory = () => {
  ...
  router.post(
    route('admin.sociallink.profession.update', editForm.value.id),
    {
      _method: 'PATCH',
            ...
            <tr v-for="category in categories.data" :key="category.id">
              <td>
                <div class="flex items-center gap-1">
                  <img :src="category.icon" alt="icon" class="w-12 object-cover" />
      ...
      <div class="drawer-body">
        ...
        <div class="mb-1">
          ...
          <input
            ...
            accept="image/*"
          />
          <InputFieldError :message="categoryForm.errors.icon" />
        </div>
        <div class="mb-1">
